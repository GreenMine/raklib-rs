...
use crate::{protocol::{packets::*, types::Reliability}, server::Session, utils::BinaryStream};

use super::UdpServer;

impl UdpServer {
	pub fn unconnected_handler(&mut self, packet_id: u8, bstream: &mut BinaryStream, addr: SocketAddr, readed_bytes: usize) -> std::io::Result<()> {
